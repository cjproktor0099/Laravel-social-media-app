...
<!--For Not Logged In Users -->
 ...
 <div class="container container--narrow">
  <div class="alert alert-success">
    ...
    @auth
    <div id="chat-wrapper" data-username="{{auth()->user()->username}}" data-avatar="{{auth()->user()->avatar}}" data-textvalue="textvalue" class="chat-wrapper shadow border-top border-bottom"></div>
    @endauth
